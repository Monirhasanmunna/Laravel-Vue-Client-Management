      ...
      <div class="w-full flex items-center ms-auto justify-between sm:gap-x-3 sm:order-3">
        ...
        <div class="flex flex-row items-center justify-end gap-2">
          ...
          <div class="relative inline-block">
            <div @click="toggleTheme" class="w-6 h-6 rounded-full text-gray-500 dark:text-gray-100 p-0.5 duration-300 hover:ring-green-500">
          ...
          <div class="hs-dropdown relative inline-flex [--placement:bottom-right]">
            ...
            <div class="hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden min-w-[15rem] bg-white shadow-md rounded-lg p-2 dark:bg-gray-800 dark:border dark:border-gray-700" aria-labelledby="hs-dropdown-with-header">
              ...
              <div class="mt-2 py-2 first:pt-0 last:pb-0">
                <Link :href="route('logout')" method="post" as="button" type="button" class="flex items-center w-full gap-x-3.5 py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100 focus:ring-2 focus:ring-blue-500 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300">
                  <svg class="flex-shrink-0 w-4 h-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M6 8a6 6 0 0 1 12 0c0 7 3 9 3 9H3s3-2 3-9"/><path d="M10.3 21a1.94 1.94 0 0 0 3.4 0"/></svg>
                  Logout
                </Link>
              </div>
